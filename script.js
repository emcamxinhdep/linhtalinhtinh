const PLUSHIES = [
  {
    ...
    comfort:
      "Bạn không cần phải mạnh mẽ mọi lúc. Được nghỉ ngơi là hoàn toàn ổn. 🌸",
    playlist: [
      "🌙 Sleeping at Last — Saturn",
      "🌧️ Norah Jones — Come Away with Me",
      "🌸 Sufjan Stevens — Mystery of Love",
    ],
    reviews: [
      {
        text: '"Ôm Lumi lần đầu mình khóc mà không biết tại sao. Nhưng sau đó mình cảm thấy nhẹ hơn."',
        mood: "💜",
      },
      {
        text: '"Bé nhỏ nhưng ấm lắm. Mình để Lumi trên đầu giường và ngủ ngon hơn."',
        mood: "🌸",
      },
    ],
  ...
  },
  {
    ...
    quote:
      '"Mochi tin rằng ngay cả những ngày tệ nhất cũng xứng đáng có một nụ cười nhỏ."',
    hobbies: [
      "Nhảy múa một mình",
      "Ăn bánh ngọt trong tưởng tượng",
      "Viết thư",
      "Vẽ mây",
    ],
    ...
    comfort:
      "Ngay cả mặt trời cũng cần nghỉ mỗi tối. Bạn cũng được phép nghỉ. ☀️",
    playlist: [
      "🍪 Conan Gray — Sunny Day",
      "🌈 Rex Orange County — Sunflower",
      "🐰 Cavetown — This Is Home",
    ],
    reviews: [
      {
        text: '"Mochi như một bó ánh nắng nhỏ trên bàn làm việc của mình. Nhìn vào là thấy vui hơn."',
        mood: "☀️",
      },
      {
        text: '"Cái bé này hay lắm. Mình hay kể chuyện cho nó nghe và không hiểu sao lại thấy đỡ hơn."',
        mood: "🌸",
      },
    ],
  ...
  },
  {
    ...
    comfort:
      "Những cảm xúc phức tạp nhất cũng sẽ tìm được ngôn ngữ của chúng, đừng vội. 🌙",
    playlist: [
      "🌙 Cigarettes After Sex — Apocalypse",
      "🎹 Yiruma — River Flows in You",
      "🌧️ bon iver — Skinny Love",
    ],
    reviews: [
      {
        text: '"Noa là người bạn đêm khuya của mình. Không hiểu sao nhìn vào mắt bé là thấy bình yên."',
        mood: "🌙",
      },
      {
        text: '"Bé đặc biệt lắm. Không giống những bé khác. Như thể bé hiểu nhiều thứ mà không nói ra."',
        mood: "💜",
      },
    ],
  ...
  },
  {
    ...
    quote:
      '"Pudding tin rằng một cái ôm thật chặt có thể chữa được nhiều thứ."',
    ...
    comfort:
      "Hôm nay bạn đã cố gắng rất nhiều rồi. Bây giờ hãy để mình ôm bạn nhé. 🐼",
    playlist: [
    ...
    reviews: [
      {
        text: '"Mua cho em gái, em ấy ôm Pudding và khóc bảo cảm ơn chị. Mình cũng không hiểu tại sao nhưng cảm động lắm."',
        mood: "💜",
      },
      {
        text: '"Bông mềm quá trời, ôm vào là muốn ngủ luôn. Mua thêm một bé nữa cho mẹ."',
        mood: "🐼",
      },
    ],
  ...
  },
  {
    ...
    hobbies: [
      "Đứng canh cửa",
      "Nghe chuyện người khác",
      "Thu thập những thứ nhỏ đáng yêu",
      "Hát khe khẽ",
    ],
    ...
    comfort:
      "Bạn được phép sợ hãi. Và bạn được phép cần được giúp đỡ. Đó không phải là yếu đuối. 🐻",
    playlist: [
      "🌿 Novo Amor — Alps",
      "🏔️ Gregory Alan Isakov — The Stable Song",
      "🌙 Iron & Wine — Naked as We Came",
    ],
    reviews: [
      {
        text: '"Mua Coco sau một giai đoạn rất khó khăn. Bé trở thành người bạn không phán xét duy nhất của mình."',
        mood: "🌿",
      },
      {
        text: '"Coco nhìn nghiêm túc nhưng ôm vào thì ấm lắm. Như được bảo vệ thật."',
        mood: "🐻",
      },
    ],
  ...
  },
  {
    ...
    quote:
      '"Mira nhắc bạn rằng mọi thứ đều có thể thay đổi — theo cách đẹp đẽ."',
    hobbies: [
      "Ngắm bình minh",
      "Thu thập cánh hoa khô",
      "Viết thơ ngắn",
      "Tưởng tượng",
    ],
    ...
    comfort:
      "Mọi bướm đều từng là sâu. Hành trình của bạn không sai — bạn chỉ đang trong quá trình. 🦋",
    playlist: [
    ...
    reviews: [
      {
        text: '"Mira đến đúng lúc mình cần tin vào bản thân nhất. Bé nhỏ bé nhưng ý nghĩa lớn."',
        mood: "🦋",
      },
      {
        text: '"Xinh lắm. Cái cánh bướm trên lưng bé làm mình mê."',
        mood: "💜",
      },
    ],
...
const VN_SCRIPTS = [
  {
    ...
    choices: [
      "Mình ổn.",
      "Mình không ổn lắm...",
      "Mình chỉ muốn ngồi đây một chút.",
    ],
  },
  {
...
const PLUSHIE_RESPONSES = {
  buồn: {
    ...
    suggest:
      "💜 Lumi có thể là người bạn phù hợp nhất cho bạn lúc này — bé biết cách ở bên trong im lặng.",
    hearts: "💜 🌸 💜",
  },
  mệt: {
    ...
    suggest:
      "🐼 Pudding có thể ôm bạn ấm áp nhất — bé được sinh ra để làm cho người khác cảm thấy an toàn.",
    hearts: "💜 ✨ 💜",
  },
  "cô đơn": {
    ...
    suggest:
      "🧸 Coco rất muốn làm bạn đồng hành của bạn — bé không bao giờ để bạn đơn độc.",
    hearts: "🌸 💜 🌸",
  },
  "lo lắng": {
    ...
    suggest:
      "🦋 Mira có thể nhắc bạn rằng những cơn lo âu cũng sẽ qua — như mọi thứ khác.",
    hearts: "✨ 💜 ✨",
  },
  "nhớ ai đó": {
    ...
    suggest:
      "🐱 Noa — người bạn đêm khuya — hiểu những cảm xúc phức tạp hơn ai hết.",
    hearts: "🌙 💜 🌙",
  },
  "không biết": {
    ...
    suggest:
      "🧸 Lumi không đặt câu hỏi — bé chỉ ở bên và lắng nghe. Có lẽ đó là điều bạn cần.",
    hearts: "🌸 💫 🌸",
  },
  "cần ôm": {
  ...
  "hạnh phúc": {
    ...
    suggest:
      "🐰 Mochi sẽ là bạn đồng hành tuyệt vời cho những ngày hạnh phúc của bạn!",
    hearts: "✨ 🌸 ✨",
  },
  default: {
    ...
    suggest:
      "🧸 Một trong những bé plushie của chúng mình chắc chắn sẽ phù hợp với bạn.",
    hearts: "💜 🌸 💜",
  },
};
...
const BLIND_BOX_CONTENTS = {
  hug: {
    ...
    items: [
      "🧸 Plushie bí mật cỡ vừa",
      "💌 Thư tay viết riêng cho bạn",
      "🎀 Ruy băng pastel",
      "🍬 Kẹo ngọt nhỏ",
      "✉️ Postcard có quote chữa lành",
    ],
  },
  tired: {
    icon: "🌙",
  ...
  miss: {
    ...
    items: [
      "🧸 Plushie mang năng lượng ấm áp",
      "📮 Set viết thư nhỏ",
      '🎵 QR playlist "I Miss You"',
      "💌 Envelope trống để bạn viết gì đó",
      "🌙 Postcard đêm khuya",
    ],
  },
  invisible: {
    ...
    items: [
      "🧸 Plushie cỡ nhỏ xinh",
      "💜 Thẻ affirmation bộ 5",
      '✨ Sticker "I see you"',
      "📝 Thư tay nhắc bạn rằng bạn quan trọng",
      "🌸 Washi tape nhỏ dễ thương",
    ],
  },
  anxious: {
    icon: "🌿",
    ...
    items: [
      "🧸 Plushie mềm để bóp khi lo lắng",
      "🌿 Hướng dẫn bài tập thở",
      '🎵 QR playlist "Anxiety Relief"',
      "💌 Thư từ Lumi về sự lo âu",
      "🌸 Sticker motivational nhỏ",
    ],
  },
  happy: {
    icon: "✨",
    ...
    items: [
      "🧸 Plushie màu sắc vui tươi",
      "🌈 Sticker set đặc biệt",
      "🎀 Hair clip nhỏ xinh",
      "💌 Thư chúc mừng bạn",
      "🌟 Mini polaroid frame",
    ],
...
function initDailyQuote() {
  ...
  document.getElementById("daily-quote-text").textContent =
...
function initComfortActivity() {
  ...
  document.getElementById("comfort-activity").innerHTML = activities
    .map(
      (a) =>
...
function selectEmotionBox(el) {
  document
    .querySelectorAll(".emotion-box-card")
  ...
  document.getElementById("reveal-items").innerHTML = box.items
    .map((item) => `<span class="reveal-item">${item}</span>`)
    .join("");
...
function orderBlindBox() {
  ...
  setTimeout(
    () => window.open("https://forms.gle/YOUR_FORM_ID_HERE", "_blank"),
    1500,
  );
}
